...
export const BannerForm: React.FC<BannerFormProps> = ({
    ...
    const description = initialData ? "Edit Banner Store" : "New Banner Store"
    const toastMessage = initialData ? "Banner success updated" : "Banner success created"
    const action = initialData ? "Save Banner" : "New Banner"
